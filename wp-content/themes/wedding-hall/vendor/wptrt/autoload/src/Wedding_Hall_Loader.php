...
class Wedding_Hall_Loader {
	 ...
	 * @return void
	 */
	public function wedding_hall_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function wedding_hall_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function wedding_hall_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function wedding_hall_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->wedding_hall_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function wedding_hall_load( $class ) {
